...
{% include figure.liquid path="assets/img/column_space.png" title="Column space of two vectors creating a plane described in grey." class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/img/basis_column.png" title="Basis space and column space representation of two points, one lying in the column space and one lying outside of it." class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid path="assets/img/least_squares.png" title="Boring Least Squares problem..." class="img-fluid rounded z-depth-1" %}
